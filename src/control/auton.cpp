...
void leftAWP() { // One yellow + left AWP
  ...
  pros::delay(100);
  chassis.drive(-2500, 1500, 3000, -12000).withGains(15, 0, 6.25).withAngle(15).withTurnGains(133,0,66).withTol(40,5).waitUntilSettled();
  chassis.turn(105,450, 4500).withTurnGains(133,0.2,66).withTol(0,2.5).waitUntilSettled();
  chassis.drive(-1500, 900, 900, -9000).withGains(15, 0, 6.25).withAngle(105).withTurnGains(133,0,66).withTol(40,5, true).waitUntilSettled();
  backLift.toggleClamp();
  chassis.turn(90,450).withTurnGains(66,0.2,33).withTol(0,2.5).waitUntilSettled();
  chassis.drive(1500, 900, 900, 3000).withGains(15, 0, 6.25).withAngle(105).withTurnGains(133,0,66).withTol(40,5).waitUntilSettled();
  chassis.drive(-1500, 900, 900, -3000).withGains(15, 0, 6.25).withAngle(105).withTurnGains(133,0,66).withTol(40,5).waitUntilSettled();
  chassis.drive(1500, 900, 900, 3000).withGains(15, 0, 6.25).withAngle(105).withTurnGains(133,0,66).withTol(40,5).waitUntilSettled();
  chassis.drive(-1500, 900, 900, -3000).withGains(15, 0, 6.25).withAngle(105).withTurnGains(133,0,66).withTol(40,5).waitUntilSettled();
  chassis.drive(1500, 900, 900, 3000).withGains(15, 0, 6.25).withAngle(105).withTurnGains(133,0,66).withTol(40,5).waitUntilSettled();
  chassis.drive(-1500).withGains(15, 0, 6.25).withAngle(90).withTurnGains(133,0,66).withTol(40,5).waitUntilSettled();
}
...
void fullAwp() { // FULL AWP
  ...
  chassis.drive(-1000, 450, 450, -6000).withGains(15, 0, 6.25).withTol(50, 10, true).waitUntilSettled();  
  backLift.toggleClamp();
