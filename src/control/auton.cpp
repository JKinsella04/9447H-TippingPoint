...
void skills(){ // No mobileGoal since it blocks GPS sensor!
  ...
  pros::delay(100);
  chassis.turn(90).withGains(266, 0.5, 133).withTol(0,7).waitUntilSettled();
  pros::delay(100);
  chassis.eDrive(90).withGains(30, 0.1, 10).withAngle(92).withTol(60, 10).waitUntilSettled();
  clamp.set_value(true);
  ...
  pros::delay(500);
  chassis.eDrive(15).withGains(30, 0.1, 10).withAngle(180).withTol(50).waitUntilSettled();
  chassis.turn(90).withGains(266, 2, 66).withTol(0,10).waitUntilSettled();
  chassis.eDrive(30).withGains(30, 0.1, 10).withAngle(90).withTol(120, 50, true).waitUntilSettled();
  pros::delay(2000);
  ...
  pros::delay(500);
  lift.setState(LiftState::UP);
  chassis.eDrive(-35).withGains(30, 0.1, 10).withTol(40).waitUntilSettled();
  pros::delay(200);
  chassis.turn(90).withGains(266, 10, 66).withTol(0,15).waitUntilSettled();
